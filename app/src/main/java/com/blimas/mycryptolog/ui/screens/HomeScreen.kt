...
fun HomeScreenPreview() {
    ...
    MaterialTheme {
        // Para o Preview, idealmente não passamos viewmodels reais ou usamos mocks.
        // Aqui apenas ajustamos para evitar erro de compilação se necessário, 
        // mas o foco é o Hilt no app.
    }
}